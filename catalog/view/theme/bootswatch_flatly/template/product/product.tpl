        ...
        <div class="<?php echo $class; ?>">
          ...
          <div id="product">
            ...
            <div class="form-group">
              ...
              <br />
              <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-warning btn-lg btn-block"><?php echo $button_cart; ?></button>
            </div>
            <?php if ($minimum > 1) { ?>
        ...
        <div class="<?php echo $class; ?>">
          <div class="product-thumb transition">
            ...
            <div class="button-group btn-group-justified">
              <button type="button" class="btn btn-default" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span> <i class="fa fa-shopping-cart"></i></button>
