      ...
      <div class="row">
        ...
        <div class="product-layout product-list col-xs-12">
          <div class="product-thumb">
            ...
            <div class="button-groupbutton-group btn-group-justified">
              <button type="button" class="btn btn-default" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span></button>
